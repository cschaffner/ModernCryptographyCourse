...
\begin{exercise}[HMAC?]
  Let $H: \{0,1\}^*\to \{0,1\}^n$ be a collision-resistant hash function. Use $H$ to construct collision-resistant hash functions $H'$ such that the following MAC functions are insecure.
  \begin{enumerate}
