...
Prove that Definition~3.8 cannot be
  ...
  experiment $\PrivK^{\eav}_{\mathcal{A},\Pi}$.
  ...
  who outputs $m_0 \in \{0, 1\}$ and a uniform $m_1 \in \{0, 1\}^{q(n)+2}$. How many possible $m_1$'s can have ciphertexts of length at most $q(n)$ if the encryption scheme is perfectly correct (i.e.\ it never fails to decrypt)?
\end{exercise}
